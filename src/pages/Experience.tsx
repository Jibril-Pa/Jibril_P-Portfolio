        ...
        <div className="w-full max-w-4xl space-y-8">
          <div className="bg-card p-6 rounded-lg shadow-md border">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground">
              <li>Created a database with over <span className="font-bold text-primary text-blue-600">77,000 IOC</span> in excel with the use of data in Zerofox, Proofpoint, and Mandiant which will be used by the DSOC team to analyze threats to HEB systems.</li>
              <li>Led a group of interns <span className="font-bold text-primary text-blue-600">10</span> interns in a conjoined project that automates a ticketing system that takes data from Splunk to Jira.</li>
              ...
              <li>Remediated over <span className="font-bold text-primary text-blue-600">50</span> devices through <span className="font-bold text-primary text-blue-600">5</span> different stores during the CrowdStrike incident of <span className="font-bold text-primary text-blue-600">2024</span></li>
              ...
              <li>Utilized the Black Kite Risk Management platform to quickly analyze and notify teams on <span className="font-bold text-primary text-blue-600">hundreds</span> of newly found vulnerabilities</li>
              <li>Partnered with over <span className="font-bold text-primary text-blue-600">10</span> digital security teams to address high-critical vulnerabilities in HEB systems</li>
          ...
          <div className="bg-card p-6 rounded-lg shadow-md border">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground">
              <li>Updated over <span className="font-bold text-primary text-blue-600">500 laptop/desktop operating systems</span>  for students to use for the upcoming school year.</li>
              <li>Ensured that damaged technology was restored or recycled based on condition.</li>
              <li>Assembled <span className="font-bold text-primary text-blue-600">50</span> newer desktops for terchnical classes to use for the upcoming school year.</li>
              <li>Installed improved security software on new laptops and desktops to keep user information private and secure.</li>
              <li>Configured operating systems and software to optimize the student user experience.</li>
              <li>Dissassembled damaged technology to salvage parts that could be reused for future use.</li>
            </ul>
          </div>
          <div className="bg-card p-6 rounded-lg shadow-md border">
            <div className="flex justify-between items-start mb-4">
          ...
          <div className="bg-card p-6 rounded-lg shadow-md border">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground">
              ...
              <li><span className="font-bold text-primary">Trained</span> new and current partners on inputting codes, restocking items, and tend to customers the H-E-B way.</li>
